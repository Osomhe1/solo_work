      ...
      <section>
        ...
        <section>
          ...
          >
            ...
            <p className='max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400'>
              Use your custom solo.to link as the bio link for your social media
              accounts to connect your audience across all the platforms you
              use.
            </p>
            <div className='flex justify-center'>
              <a
                ...
                href='https://github.com/r1/nine4-2/'
              >
                <span className='justify-center px-6 py-4'>Create Account</span>
              </a>
            </div>
          </div> */}
          </div>
        ...
        >
          <div class='grid lg:mt-0 lg:col-span-5 p-10 w-full cursor-pointer text-center rounded-lg  bg-white hover:text-blue-600 '>
            <div className='py-6'>
              <h4 className='text-black text-4xl py-4 font-bold  '>Get your link</h4>
              <div className='flex justify-center'>
                <a
                  className='inline-flex items-center px-5 py-3  mt-2 font-medium text-white transition duration-500 ease-in-out transform bg-transparent border rounded-lg bg-gray-900'
                  href='https://github.com/r1/nine4-2/'
